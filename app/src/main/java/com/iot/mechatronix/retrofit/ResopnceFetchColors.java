...
public class ResopnceFetchColors {
    ...
    public ResopnceFetchColors(Boolean error, String message, Data data) {
        this.error = error;
    ...
    public class Data {
        ...
        public class Colour {
            ...
            public class Pivot {
                ...
                public Pivot(Integer productShadeCardId, Integer colourId) {
